...
Both of the algorithms are implemented in the same language and with the same built-in functions and data structures for as long as possible, to rule out differences to obtain a realistic comparison in the end.
We need to run the algorithms a number of times to obtain a good set of data for the comparison. The data will be obtained during the runs by saving informations about the runs on files.  
