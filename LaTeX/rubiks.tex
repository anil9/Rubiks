...
\chapter{Conclusion}
From the methods we measured Lbl with daisy method solved the cube with the least amount of moves in more than 70\% of the time and also had both the lowest moves in minima and the maxima on the cubes we tested.
\cite{MadeHow}
