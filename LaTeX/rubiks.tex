...
Fig \ref{fig_21} and fig \ref{fig_22} represents the moves used in each step for both methods. This shows the differences in amount of moves used for the different steps. Where the biggest differences are between  
