...
\chapter{Method}
For this thesis the two methods used were implementation of algorithms and analyzis of the data representation. The implementations allowed analyzation and collection of data from multiple runs.
