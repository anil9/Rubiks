...
\section{Comparison}
As we can see in the results fig \ref{fig_18}, Lbl with daisy method has the lowest amount of moves the majority of the time. Lbl with daisy method also has the lowest minimum and maximum amount of moves with 91 and 249 respectively. The corresponding values for the Dedmore method are 104 and 285 REF TO DATA. This shows that Lbl wins in average, best case and worst case and the result of this is shown in fig \ref{fig_19}.\\\\
