...
\chapter{Method}
For this thesis the two methods used were implementation of methods and analyzis of the data representation. The implementations allowed analyzing and collection of data from multiple executions.
Both of the algorithms was implemented in the same programming language and with the same built-in functions and data structures to rule out unnecessary differences and obtain a realistic comparison.
The algorithms were executed a number of times on different cubes to obtain a good set of data for the comparison. The data was obtained during the executions by gathering information as: number of moves used, statistics of moves used and number of times the algorithm used least amount of moves.  
