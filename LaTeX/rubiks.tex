...
\begin{foreignabstract}{swedish}
  Om du skulle rotera sidorna av en Rubik's kub slumpvis i ett försök att lösa kuben, skulle det vara nästan ingen chans alls att lyckas lösa kuben under din livstid. Denna rapport utforskar två allmänt kända nybörjarmetoder för fysisk lösning av Rubik's kuben, för att finna hur dem skiljer sig åt i tid samt antal förflyttningar för att nå lösningen. Metoderna implementerades och kördes på ett stort antal blandade kuber för att samla data. Resultatet visar att Lager-för-lager med daisy metoden hade ett lägre genomsnittligt antal förflyttningar jämfört med dedmore metoden. The största skillnaden i antalet förflyttningar ligget i stegen som löser sista lagret av kuben. Lager-för-lager med daisy metoden använder bara en sjundedel av de mest tidskrävande förflyttningarna jämfört med dedmore metoden, slutsatsen ur detta är att lager-för-lager med daisy metoden är bättre lämpad för lösning av kuben på tid.  
\end{foreignabstract}
